...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      //E-> [E O E]
      Regra r10 = new Regra(E);
      r10.addSimboloDireita(E);
      r10.addSimboloDireita(O);
      r10.addSimboloDireita(E);

      //E-> N
      Regra r11 = new Regra(E);
      r11.addSimboloDireita(N);

      //E-> V
      Regra r12 = new Regra(E);
      r12.addSimboloDireita(V);

      //O-> +
      Regra r13 = new Regra(O);
      r13.addSimboloTerminalDireita("+");

      //O-> -
      Regra r14 = new Regra(O);
      r14.addSimboloTerminalDireita("-");

      //O-> *
      Regra r15 = new Regra(O);
      r15.addSimboloTerminalDireita("*");

      //O-> /
      Regra r16 = new Regra(O);
      r16.addSimboloTerminalDireita("/");

      /* Statements */

      //S-> if C { S } ELSE
      Regra r17 = new Regra(S);
      r17.addSimboloTerminalDireita("if");
      r17.addSimboloDireita(C);
      r17.addSimboloTerminalDireita("{");
      r17.addSimboloDireita(S);
      r17.addSimboloTerminalDireita("}");
      r17.addSimboloDireita(ELSE);

      //ELSE-> else { S }
      Regra r18 = new Regra(ELSE);
      r18.addSimboloTerminalDireita("else");
      r18.addSimboloDireita(S);
